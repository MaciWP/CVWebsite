  ...
  return (
    <div className="App">
      <HelmetProvider>
        <Helmet>
          <title>
            {t("header.name")} - {t("introduction.title")}
          </title>
          <meta name="description" content={t("introduction.description")} />
          <meta
            name="keywords"
            content="software developer, Python, Django, AWS, Docker"
          />

          {/* Open Graph tags */}
          <meta
            property="og:title"
            content={`${t("header.name")} - ${t("introduction.title")}`}
          />
          <meta
          ...
          <meta
            property="og:image"
            content="https://oriolmacias.dev/profile-image.jpg"
          />
